...
import com.portfolio.ms.Secutiry.Service.RolService;
import com.portfolio.ms.Secutiry.Service.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        if(nuevoUsuario.getRoles().contains("admin"))
            roles.add(rolService.getByRolNombre(RolNombre.RELE_ADMIN).get());
    ...
    public ResponseEntity<JwtDTO> login(@Valid @RequestBody LoginUsuario loginUsuario, BindingResult bindingResult){
        ...
        JwtDto jwtDro = new JwtDto(jwt, userDetails.getUsername(), userDetails.getAuthorities());
    }
}
